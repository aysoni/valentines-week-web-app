...
import ValentineTabs from "./ValentinesTab.jsx";
...
export default function Page() {
  ...
  useEffect(() => {
    if (yesPressed && noCount < 4 && !popupShown) {
      Swal.fire({
        title: "I love you sooo much, meri Cutu ❤️ You’ve captured my heart completely 🥰💖 Par itni pyaari ladki aur itni jaldi haan? Thoda aur nakhre, thoda aur pyaar dikhao na, Cutu ✨💕",
        showClass: {
          popup: `
            animate__animated
            animate__fadeInUp
  ...
  useEffect(() => {
    if (yesPressed && noCount > 3 && !yespopupShown) {
      Swal.fire({
        title: "I love you so much, Cutu ❤️ You are my happiness, my strength, and my forever. Every second with you is a memory I’ll hold close to my heart, because my heart belongs only to you.</br> Will you be the love of my life, forever and always?",
        width: 800,
        padding: "2em",
        color: "#716add",
        background: `#fff url(${swalbg})`,
